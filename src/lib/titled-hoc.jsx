    ...
    class TitledComponent extends React.Component {
            ...
            axios.get(`http://localhost:8000/api/scratch`, {
                ...
                if (response.data.success) {
                    if (response.data.data) {
                        return this.handleReceivedProjectTitle(response.data.data.projectTitle);
                    } else {
                        return this.handleReceivedProjectTitle(this.props.projectTitle);
                    }
                }
            }).catch(err => {
                console.log(err);
        ...
        componentDidUpdate(prevProps) {
            ...
            if (this.props.isShowingWithoutId && prevProps.isAnyCreatingNewState) {
                ...
                const defaultProjectTitle = this.getTitle();
