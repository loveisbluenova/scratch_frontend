...
const reducer = function (state, action) {
    ...
    case DONE_FETCHING_WITH_ID:
        if (state.loadingState === LoadingState.FETCHING_WITH_ID) {
            console.log('action.projectData ===> 45', action.projectData)
            return Object.assign({}, state, {
                loadingState: LoadingState.LOADING_VM_WITH_ID,
        ...
        case DONE_FETCHING_DEFAULT:
            ...
            console.log('action.projectData ===> 46',action.projectData)
            return Object.assign({}, state, {
                loadingState: LoadingState.LOADING_VM_NEW_DEFAULT,
                projectData: action.projectData
            });
    ...
    case START_MANUAL_UPDATING:
        ...
        console.log('state', JSON.parse(state.projectData));
        console.log(LoadingState.SHOWING_WITH_ID,"LoadingState");
        if (state.loadingState === LoadingState.SHOWING_WITH_ID) {
            return Object.assign({}, state, {
                loadingState: LoadingState.MANUAL_UPDATING
            });
...
const onFetchedProjectData = (projectData, loadingState) => {
    console.log('action.projectData 43', projectData)
    switch (loadingState) {
